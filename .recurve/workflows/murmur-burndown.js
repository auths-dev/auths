...
- never git reset/checkout shared state. SACRED (do not touch): ~/.auths, global git config, live Docker. Simulators are ALLOWED for this suite — you MAY \`xcrun simctl\` boot a sim and screenshot to verify your work.
