...
class Auths:
    ...
    def sign_as(self, message: bytes, identity: str, passphrase: Optional[str] = None) -> str: ...
    def sign_action_as(self, action_type: str, payload: str, identity: str, passphrase: Optional[str] = None) -> str: ...
