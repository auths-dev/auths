...
class PresentationStatus(enum.Enum):
    VALID = ...
    HOLDER_NOT_CURRENT_KEY = ...
    WRONG_AUDIENCE = ...
    NONCE_MISMATCH_OR_CONSUMED = ...
    EXPIRED = ...
    SUBJECT_KEL_INVALID = ...
...
class CredentialStatus(enum.Enum):
    ...
    REGISTRY_NOT_ESTABLISHED = ...
    CREDENTIAL_REVOKED = ...
    EXPIRED = ...
    WITNESS_QUORUM_NOT_MET = ...
    ISSUER_KEL_DUPLICITOUS = ...
    MALFORMED_REQUEST = ...
    INPUT_TOO_LARGE = ...
    UNSUPPORTED_SCHEMA_VERSION = ...
    UNKNOWN = ...
...
class PresentationReport:
    ...
    role: str | None
    expires_at: str | None
    credential: CredentialReport | None
    message: str | None
    field: str | None

def verify_presentation(request_json: str) -> PresentationReport: ...
def verify_credential(request_json: str) -> CredentialReport: ...
...
class OrgService:
    ...
    def add_member(self, org_did: str, member_label: str, role: str = "member", capabilities: list[str] | None = None, repo_path: str | None = None, passphrase: str | None = None, expires_at: int | None = None) -> OrgMember: ...
    def revoke_member(self, org_did: str, member_did: str, repo_path: str | None = None, passphrase: str | None = None) -> OrgMember: ...
    def update_member(self, org_did: str, member_did: str, member_label: str, role: str | None = None, capabilities: list[str] | None = None, repo_path: str | None = None, passphrase: str | None = None) -> OrgMember: ...
...
class WitnessService:
    def add(self, url: str, aid: str, label: str | None = None, repo_path: str | None = None) -> Witness: ...
