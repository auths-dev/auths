...
pub fn explain(code: &str) -> Option<&'static str> {
    match code {
        ...
        "AUTHS-E3002" => Some("# AUTHS-E3002\n\n**Crate:** `auths-core`\n\n**Type:** `AgentError::IncorrectPassphrase`\n\n## Message\n\nIncorrect passphrase\n\n## Suggestion\n\nCheck your passphrase and try again. Set AUTHS_PASSPHRASE for automation, or run `auths daemon start` for session caching\n"),
        ...
        "AUTHS-E3019" => Some("# AUTHS-E3019\n\n**Crate:** `auths-core`\n\n**Type:** `AgentError::AgentLocked`\n\n## Message\n\nAgent is locked. Unlock with 'auths daemon unlock' or restart the agent.\n\n## Suggestion\n\nRun `auths daemon unlock` or restart with `auths daemon start`\n"),
