...
#if canImport(murmur_ffiFFI)
import murmur_ffiFFI
#endif
...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_murmur_ffi_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_murmur_ffi_rustbuffer_free(self, $0) }
    }
}
...
private func makeRustCall<T, E: Swift.Error>(
    ...
    uniffiEnsureMurmurFfiInitialized()
...
#if compiler(>=6)
extension MurmurError: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeMurmurError: FfiConverterRustBuffer {
    typealias SwiftType = MurmurError

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> MurmurError {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeMurmurError_lift(_ buf: RustBuffer) throws -> MurmurError {
    return try FfiConverterTypeMurmurError.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeMurmurError_lower(_ value: MurmurError) -> RustBuffer {
    return FfiConverterTypeMurmurError.lower(value)
}
...
#if compiler(>=6)
extension TrustBadge: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeTrustBadge: FfiConverterRustBuffer {
    typealias SwiftType = TrustBadge
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeTrustBadge_lift(_ buf: RustBuffer) throws -> TrustBadge {
    return try FfiConverterTypeTrustBadge.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeTrustBadge_lower(_ value: TrustBadge) -> RustBuffer {
    return FfiConverterTypeTrustBadge.lower(value)
}
 ...
 */
public func addressCanonical(text: String) -> String  {
    return try!  FfiConverterString.lift(try! rustCall() {
    uniffi_murmur_ffi_fn_func_address_canonical(
...
public func coreVersion() -> String  {
    return try!  FfiConverterString.lift(try! rustCall() {
    uniffi_murmur_ffi_fn_func_core_version($0
    )
})
}
/**
 ...
 */
public func evaluateTrust(priorKeystate: String, currentKeystate: String)throws  -> TrustBadge  {
    return try  FfiConverterTypeTrustBadge_lift(try rustCallWithError(FfiConverterTypeMurmurError_lift) {
    uniffi_murmur_ffi_fn_func_evaluate_trust(
        FfiConverterString.lower(priorKeystate),
        FfiConverterString.lower(currentKeystate),$0
    )
})
}
/**
 ...
 */
public func sealMessage(to: String, from: String, body: String)throws  -> Data  {
    return try  FfiConverterData.lift(try rustCallWithError(FfiConverterTypeMurmurError_lift) {
    uniffi_murmur_ffi_fn_func_seal_message(
...
private let initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_murmur_ffi_uniffi_contract_version()
    if bindings_contract_version != scaffolding_contract_version {
        return InitializationResult.contractVersionMismatch
    }
    if (uniffi_murmur_ffi_checksum_func_address_canonical() != 45550) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_murmur_ffi_checksum_func_core_version() != 3647) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_murmur_ffi_checksum_func_evaluate_trust() != 39842) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_murmur_ffi_checksum_func_seal_message() != 54523) {
        return InitializationResult.apiChecksumMismatch
    }
...
public func uniffiEnsureMurmurFfiInitialized() {
