...
/// SCIM 2.0 Error response message schema URI (RFC 7644 Section 3.12).
pub const SCHEMA_ERROR: &str = "urn:ietf:params:scim:api:messages:2.0:Error";

/// SCIM 2.0 PatchOp message schema URI (RFC 7644 Section 3.5.2).
pub const SCHEMA_PATCH_OP: &str = "urn:ietf:params:scim:api:messages:2.0:PatchOp";

/// Auths agent extension schema URI.
pub const SCHEMA_AUTHS_AGENT: &str = "urn:ietf:params:scim:schemas:extension:auths:2.0:Agent";
